        ...
        <div className="page-card-div">
          <div className="page-card">
            <p>
              ...
              review and track your previous results instantly. With a clean
              layout and responsive design, it handles everything from simple
              sums to complex percentages with ease. We invite you to experience
              a more organized way to manage your numbers today.
            </p>
          </div>
        </div>
